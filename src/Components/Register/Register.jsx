    ...
    return (
        ...
        flex items-center justify-center">
              ...
              px-4 py-3 mt-6">Sign Up</button>
                        ...
                        <button type="button" className="w-full block mt-5 bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
                            <div className="flex items-center justify-center">
